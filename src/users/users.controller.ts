...
export class UsersController {
  ...
  async getMyTasks(
    @Req() req: Request,
    @Headers("Content-Language") lang: string,
    @Query("type(pending|ongoing|completed)") type: string,
    @Query("page") page: number,
    @Query("limit") limit: number,
    @Res() res: Response
  ) {
    return await this.usersService.getMyTasks(req, type, page, limit, res);
  }
  ...
  async getAllTasks(
    ...
    return await this.usersService.getAllTasks(
      req,
      lang,
      page,
      limit,
  ...
  async updateTeam(
    ...
    return await this.usersService.updateTeam(req, lang, body, res);
  }
}
